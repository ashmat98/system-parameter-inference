...
\input{slides/amplitude.tex}
\input{slides/resonance_curve.tex}

\section{Bayesian Approach}
\input{slides/bayes.tex}
\input{slides/statanalysis.tex}

\begin{frame}{}
\begin{beamercolorbox}[sep=8pt,center,shadow=true,rounded=true]{title}
    \usebeamerfont{title}{\Huge Thank You}\par%
\end{beamercolorbox}
